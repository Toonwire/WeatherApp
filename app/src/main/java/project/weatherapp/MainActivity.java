...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        leftOverview = (TableLayout) findViewById(R.id.overview_left);
        rightOverview = (TableLayout) findViewById(R.id.overview_right);
        overviewRain = (TableRow) findViewById(R.id.overview_rain);
        overviewHumidity = (TableRow) findViewById(R.id.overview_humidity);
        overviewPressure = (TableRow) findViewById(R.id.overview_pressure);
        overviewWind = (TableRow) findViewById(R.id.overview_wind);
        overviewSunRiseSet = (TableRow) findViewById(R.id.overview_sunriseset);
